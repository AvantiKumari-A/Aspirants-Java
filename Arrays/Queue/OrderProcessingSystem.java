/* Sita is developing an order processing system for a company. 
To efficiently manage incoming orders, she decides to implement a queue data structure using an array. 
The queue will store order IDs. 
...
Option 1: Enqueue a new order ID into the queue. 
The next line contains an integer representing the element to be inserted.
        ...
        while (sc.hasNextInt()) {
            ...
            if (n == 1) {
                ...
                if (f == r)
                    ...
                    System.out.println("Processed Order ID: " + q[f]);
                    f++;
                }
            } 
            else if (n == 3) {
